...
def find_crosswalk_human_car(image_path):
    # 이미지 읽기
 ...
 #detect_human_car(image_path)
    
    # read image
    #img = cv2.imread(image_path) 여기 부분은 겹침에 따라 주석 처
...
# 이미지 경로 설정 후 함수 호출
find_crosswalk_human_car('walk_people.jpg')
